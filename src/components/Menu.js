    ...
    <section className="mih-h-[780px]">
      ...
      <div className="relative z-10 top-72 lg:top-52">
        <motion.div
          ...
          <motion.h2
            variants={fadeIn('down', 'twen', 0.2, 1.6)}
            className="h2 capitalize text-white max-w-400px">
            {title}
          </motion.h2>
          <motion.p
            variants={fadeIn('down', 'twen', 0.4, 1.6)}
            className="text-white/70 capitalize mb-8">
            {subtitle}
          </motion.p>
          <motion.div variants={fadeIn('down', 'twen', 0.6, 1.6)}>
      ...
      <motion.div
        ...
        <div className="container mx-auto">
          <div className="lg:-mt-24 min-h-[590px] z-30 mb-8 md:mb-4 xl:mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-4 min-h-[590-px]">
                ...
                return (
                  <div key={index}>
                    <div className="flex flex-row lg:flex-col h-full">
                      ...
                      <div className="bg-[#fff3e4] flex-1 flex-col justify-center px-6 lg:p-12 lg:max-h-[250px] xl:max-h-max">
